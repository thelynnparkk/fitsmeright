...
extension StateView {
  ...
  func setupLight() {
    ...
    s_loading.img_icon = UIImage(color: .white, size: .less)
    s_loading.img_background = UIImage(color: .black, size: .less)
    ...
    s_noResults.img_icon = UIImage(color: .white, size: .less)
    s_noResults.img_background = UIImage(color: .black, size: .less)
    ...
    s_noConnection.img_icon = UIImage(color: .white, size: .less)
    s_noConnection.img_background = UIImage(color: .black, size: .less)
    let s_error = StateViewDisplayed.Setting()
    s_error.title = "Something went wrong"
    s_error.description = "Please try again"
    s_error.tint = .white
    s_error.img_icon = UIImage(color: .white, size: .less)
    s_error.img_background = UIImage(color:.black, size: .less)
    let displayed = StateViewDisplayed()
